...
<div class="row accessorial-card">
    ...
    <script>var accesorial_count2 = 0;</script>
        ...
        @if(isset($data)&&$data->accessories->where('type', 'expense')->count() != 0)
                ...
                @foreach($data->accessories->where("type","expense") as $key=>$accessory)
                    ...
                    <tr id="div2_num_accesorials{{$expenses_count}}" onclick="selectRow('{{$expenses_count}}','2')">
                        ...
                        @endif
                        <td id="a2ccessory_div{{$expenses_count}}"><input id="value_a2ccesorial{{$expenses_count}}"  value="${{$accessory->value}}" type="text" name="accessory_value2[]" class="form-control text-right accessory_value accessory_value_expense currency"  onchange="calculate_accessorial_expense()"></td>
                    </tr>
                    <script>
        ...
        <tr id="div2_num_accesorials0" onclick="selectRow('{{0}}','2')">
            ...
            <td id="a2ccessory_div0"><input id="value_a2ccesorial0" type="text" name="accessory_value2[]" class="form-control text-right accessory_value accessory_value_expense currency"  onchange="calculate_accessorial_expense()"></td>
        </tr>
        @endif
        </tbody>
        <tfooter>
