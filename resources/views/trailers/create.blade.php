        ...
        <div class="box box-primary">
            ...
            <form id="form1" role="form" method="post" action="{{$url}}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group col-md-6">
                        <label for="number">{{__("tran.Trailer Number")}}</label>
                        <input type="text" name="number" class="form-control" id="number" placeholder="{{__("tran.Trailer Number")}}" value="{{isset($data) ? $data->number:""}}">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <label for="type">{{__("tran.Trailer Type")}}</label>
                        <input type="text" name="type" class="form-control" id="type" placeholder="{{__("tran.Trailer Type")}}" value="{{isset($data) ? $data->type:""}}">
                    </div>
