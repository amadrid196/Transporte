...
class LoadController extends Controller
{
    ...
    public function loads_ajax($categoryId = 0)
    {
        ...
        $table_data = Load::with("driver", "shipper", "tractor", "trailer", "consignee", 'broker', 'messageRecords', 'accessories');
    ...
    public function create()
    {
        ...
        $title = "Create load";
        $icon_name = "fa-list-alt";
        return view("loads.create", compact('title', 'icon_name', "pageTitle", "url", "page"));
    }
    ...
    public function edit($id)
    {
        ...
        return view("loads.create", compact("pageTitle", 'title', 'icon_name', "url", "data", 'lat', 'long'));
    }
