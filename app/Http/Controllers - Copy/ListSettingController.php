...
class ListSettingController extends Controller
{
    ...
    {
        $pageTitle = "List Settings Create";
        $url = route('listsettings-store');
        $groups =$this->groups;
        return view('listsettings.create', compact('pageTitle', 'url', 'groups'));
    }
    ...
    public function edit($id)
    {
        ...
        $pageTitle = "List Settings Edit";
        $url = route("listsettings-update", $id);
        $groups =$this->groups;
        return view("listsettings.create", compact("pageTitle", "url", "data", 'groups'));
    }
