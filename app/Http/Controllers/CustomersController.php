...
class CustomersController extends Controller
{
    public function index()
    {
        ...
        $title = "Locations";
        $icon_name = "fa-map-marker";
        $add_btn_txt = "Add New Location";
        //        $min_max_filter = ["value" => true, "min" => 8, "max" => 8, "type" => "date"];
        return view("data_table", compact("title","icon_name","show_add_button","add_btn_txt","page", "add_button_link", "title_tag", "title_on_page", "table_headers", "ajax_data_getting_url"));
    ...
    public function create()
    {
        ...
        return view("customers.create", compact("pageTitle", "url", 'title', 'icon_name'));
    }
    ...
    public function edit($id)
    {
        ...
        return view("customers.create", compact("pageTitle", "url", "data", 'title', 'icon_name'));
    }
