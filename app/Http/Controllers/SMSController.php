...
class SMSController extends Controller
{
    ...
    public function sendBulkSms(Request $request)
    {
        ...
        foreach($loadIds as $val)
        {
            $load = Load::with("driver", "shipper", "tractor", "trailer", "consignee")->where('id', $val)->first();
    ...
    public function sendExpirationEmail($driverId)
    {
        ...
        $diffDays = (int)(($currentDate - $medicalExpirationDate)/86400);
        ...
        if($diffDays >= 30)
        {
            ...
            }else
            {
                ...
                $emailDiffDays = (int)(($currentDate - $lastEmailDate)/86400);
        ...
        $diffDays = (int)(($currentDate - $driverExpirationDate)/86400);
