...
class BrokerController extends Controller
{
    public function index()
    {
        ...
        $table_headers = [ __("tran.Name"),__("tran.Primary Phone"),  __("tran.Address"), __("tran.Action")];
        $ajax_data_getting_url = route("brokers-ajax");
        // $multi_select = false;
        $page="brokers-index";
        //        $min_max_filter = ["value" => true, "min" => 8, "max" => 8, "type" => "date"];
        return view("data_table", compact("page",'add_btn_txt','title', 'icon_name', "show_add_button", "add_button_link", "title_tag", "title_on_page", "table_headers", "ajax_data_getting_url"));
    ...
    public function create()
    {
        ...
        return view("brokers.create", compact('title', 'icon_name',"pageTitle", "url"));
    }
    ...
    public function edit($id)
    {
        ...
        return view("brokers.create", compact("pageTitle", "url", "data", 'title', 'icon_name'));
    }
